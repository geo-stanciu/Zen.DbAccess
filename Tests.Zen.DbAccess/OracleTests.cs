...
namespace Tests.Zen.DbAccess
{
    ...
    public class OracleTests : CommonTestSetup
    {
        ...
        public async Task TestBulkInsert()
        {
            ...
            await models.BulkInsertAsync(dbConnectionFactory.DbType, conn, "t1");
        ...
        public async Task TestBulkInsertWithSequence()
        {
            ...
            await models.BulkInsertAsync(dbConnectionFactory.DbType, conn, "t1", sequence2UseForPrimaryKey: "t1_seq");
            ...
            await resultModels.SaveAllAsync(dbConnectionFactory.DbType, conn, "t1", sequence2UseForPrimaryKey: "t1_seq");
